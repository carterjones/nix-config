...
# Remove the trailing separator arrow so nothing follows the last segment.
POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=""
# Remove the leading arrowhead so nothing precedes the first right-prompt segment.
